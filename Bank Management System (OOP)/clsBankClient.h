...
private:
    ...
    static stTransferLogRecord _ConvertTransferLogLineToRecord(string Line, string Seperator = "#//#")
    {
        ...
        TransferLogRecord.sAcountNumber = TransferLogDataLine[1];
        TransferLogRecord.dAcountNumber = TransferLogDataLine[2];
        TransferLogRecord.Amount = stoi(TransferLogDataLine[3]);
        TransferLogRecord.sBalance = stoi(TransferLogDataLine[4]);
        TransferLogRecord.dBalance = stoi(TransferLogDataLine[5]);
